...
Notes: output ICs from Melodic will be renamed to be consistent with fslx conventions. The Melodic report folder
will also be saved, and the mask.nii.gz and mean.nii.gz will be placed inside of it.
